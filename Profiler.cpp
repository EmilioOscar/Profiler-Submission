...
namespace LightweightProfiler {
    ...
    // Macro Frame Timers and Lock-Free Ring Buffer Logic
    
    void FrameProfiler::BeginFrame() {
        // Record timestamp at the very start of the loop
  ...
  void FrameProfiler::EndFrame() {
        ...
        // find the  longest scope (The Root).
        ...
        // Lock-Free Circular Index Counter
        ...
        //  Write actual OS Data into the array instead of 0.0f
